...
export default function Blog() {
  ...
  return (
    <main className={styles.blogContainer}>
      ...
      {/* Blog Content */}
      <section className={`container fade-in ${styles.blogContainer}`}>
        <div className="row">
          <div className="col-12">
            <h1 className={styles.blogTitle}>Life Lessons for My Sons</h1>
            <p className={styles.blogSubtitle}>What I Hope Charlie and Everett Will Always Remember</p>
            ...
            <div className={styles.blogContent}>
              ...
              <div className={styles.lessonContent}>
                <div className={styles.lessonPoint}>
